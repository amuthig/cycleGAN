...
optimizer_G = optim.Adam(cycle_gan.gen_A.parameters(), lr=0.0002, betas=(0.5, 0.999))
optimizer_D = optim.Adam(cycle_gan.dis_A.parameters(), lr=0.0002, betas=(0.5, 0.999))
